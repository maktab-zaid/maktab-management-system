...
const TIME_STRUCTURE = [
  { slot: "Fajr (Morning)", time: "7:00 AM to 9:00 AM", emoji: "🌅" },
  { slot: "Afternoon", time: "2:00 PM to 4:00 PM", emoji: "☀️" },
  { slot: "Evening", time: "Maghrib Azaan to Isha Azaan", emoji: "🌙" },
];
...
export default function AboutUsAdminPage({ setActivePage }: Props) {
  return (
    <div className="space-y-6 page-enter" data-ocid="admin.about_us.page">
      <Button
        variant="ghost"
        size="sm"
        onClick={() => setActivePage("dashboard")}
        className="gap-1.5 text-muted-foreground hover:text-foreground"
        data-ocid="admin.about_us.back_button"
      >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {COURSES.map((c, i) => (
                <div
                  ...
                  data-ocid={`admin.about_us.course.${i + 1}`}
                >
            ...
            <div className="space-y-3">
              {TIME_STRUCTURE.map((t, i) => (
                <div
                  ...
                  data-ocid={`admin.about_us.time.${i + 1}`}
                >
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="p-5">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              individual attention to each student, with modern digital tracking
              of progress.
            </p>
        ...
        <Card>
          <CardContent className="p-5">
            ...
            <p className="text-xs text-muted-foreground mb-3">
              Exciting new programmes coming soon to expand student skills:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {UPCOMING_PROGRAMS.map((p, i) => (
                <div
                  ...
                  data-ocid={`admin.about_us.upcoming.${i + 1}`}
                >
                  <span className="text-xl" aria-hidden="true">
                    {p.emoji}
                  </span>
